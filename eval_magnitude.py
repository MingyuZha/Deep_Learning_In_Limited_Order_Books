...
if __name__ == "__main__":
    ...
    batch_size = 128
    # print (len(dataset))
    model = torch.load("./saved_model_" + stock_name + "/" + stock_name + ".model2", map_location='cpu')
    model.eval()
    result = eval(model, root, stock_name, num_levels, input_size, sequence_len, batch_size)
